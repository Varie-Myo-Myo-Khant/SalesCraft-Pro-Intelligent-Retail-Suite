...
import { addLocalStorageCart, getLocalStorageCart } from '../Services/localStorage'
...
export const cartSlice = createSlice({
    ...
    reducers: {
        ...
        addToCart: (state, action) => {
            ...
            if (cartIndex >= 0) {
                if (state.cartItems[cartIndex].quantity < state.cartItems[cartIndex].stockQuantity) {
